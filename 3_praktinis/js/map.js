...
function loadThematicLayers() {
  ...
  map.addSource("national_roads_source", {
    type: "raster",
    tiles: [
      "http://localhost/qgisserver/national_roads_map?bbox={bbox-epsg-3857}&format=image/png&service=WMS&version=1.1.1&request=GetMap&srs=EPSG:3857&transparent=true&width=256&height=256&layers=valstybinis_keliu_tinklas",
    ],
    tileSize: 256,
  });
  ...
  map.addSource("statistics_source", {
    type: "raster",
    tiles: [
      "http://localhost/qgisserver/vda_gyventojai?bbox={bbox-epsg-3857}&format=image/png&service=WMS&version=1.1.1&request=GetMap&srs=EPSG:3857&transparent=true&width=256&height=256&layers=gyventoju_zemelapis",
    ],
    tileSize: 256,
  });
  ...
  map.addLayer({
    id: "national_roads_wms",
    type: "raster",
    source: "national_roads_source",
    layout: {
      visibility: "none",
    },
    paint: {},
